...
#ifndef FlexibleDelayLinesConfig_H
#define FlexibleDelayLinesConfig_H
...
namespace FlexibleDelayLinesConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 6286;
}

#endif // FlexibleDelayLinesConfig_H
