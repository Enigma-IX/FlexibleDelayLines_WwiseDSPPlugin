...
local Plugin = {}
Plugin.name = "FlexibleDelayLines"
Plugin.factoryheader = "../SoundEnginePlugin/FlexibleDelayLinesFXFactory.h"
Plugin.appleteamid = ""
Plugin.signtoolargs = {}
Plugin.sdk = {}
Plugin.sdk.static = {}
...
{
    "FlexibleDelayLinesFXShared.cpp"
}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "FlexibleDelayLines.def",
    "FlexibleDelayLines.xml",
    "**.rc",
}
